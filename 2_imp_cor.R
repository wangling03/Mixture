...
#corcnt05_imp=as.matrix(read.delim("E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\gene_hc_count05.txt", row.names = 1, header= TRUE))
#corcnt06_imp=as.matrix(read.delim("E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\gene_hc_count06.txt", row.names = 1, header= TRUE))

corcnt05_imp=as.matrix(read.delim("./data_file/gene_hc_count05.txt", row.names = 1, header= TRUE))
corcnt06_imp=as.matrix(read.delim("./data_file/gene_hc_count06.txt", row.names = 1, header= TRUE))


hist(corcnt05_imp)
quantile(corcnt05_imp, probs = seq(0, 1, 0.25))

hist(corcnt06_imp)
quantile(corcnt06_imp, probs = seq(0, 1, 0.25))


#corcnt_keep=subset(corcnt05_imp,  corcnt05_imp > 4500)
#6629 rows
...
data_hc_all = dplyr::bind_rows(data_chrna6, data_hc) #merge(data_chrna6, data_hc, by="col.names", all=TRUE)

#write.table(data_hc_all, "E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\data_hc_06.txt", sep="\t")
#write.csv(data_hc_all, file = "E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\data_hc_06.csv")

write.table(data_hc_all, "./data_file/data_hc_06.txt", sep="\t")
write.csv(data_hc_all, file = "./data_file/data_hc_06.csv")
...
#eps_graph_name="E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\corcnt05.eps"
#pdf_graph_name="E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\corcnt05.pdf"
#png_graph_name="E:\\C drive\\Ling MSU paper\\paper 3\\Paper 3\\ZLiao\\real_data_study4\\data_file\\corcnt05.png"

eps_graph_name="./data_file/corcnt06.eps"
pdf_graph_name="./data_file/corcnt06.pdf"
png_graph_name="./data_file/corcnt06.png"
